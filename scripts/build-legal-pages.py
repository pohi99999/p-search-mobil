...
The notice text is NOT edited here. The only substitutions are the two the owner
asked for (2026-09-23): the effective date, and the square brackets around the
in-app path, because the feature now exists. Every substitution asserts that it hit
